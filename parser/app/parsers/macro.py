...
Parses Banco Macro credit card statement PDFs.
Supports Visa and Mastercard statements.
"""
...
class MacroParser(BaseParser):
    """Parser for Banco Macro credit card statements."""
    ...
    def can_parse(self, text: str) -> bool:
        return bool(re.search(r"macro", text, re.IGNORECASE))
    ...
    def _extract_amounts(self, text: str) -> dict:
        ...
        # Saldo anterior (Macro typically shows this)
        m = re.search(
    ...
    def _extract_transactions(self, text: str) -> list[ParsedTransaction]:
        ...
        logger.info(f"Extracted {len(transactions)} transactions from Macro statement")
        return transactions
    ...
    def parse(self, text: str) -> ParsedStatement:
        """Parse Macro statement text into structured data."""
        logger.info("Parsing Banco Macro statement...")
